    ...
    -- Library element functions
                    ...
                    for _, section in cfg.tabs do
                        ...
                        local multi_items = data.items; do 
                            ...
                            -- Tab 
                                ...
                                multi_items[ "left" ] = library:create( "Frame" , {
                                    Parent = multi_items[ "tab" ];
                                    BackgroundTransparency = 1;
                                    Name = "\0";
                                    BorderColor3 = rgb(0, 0, 0);
                                ...
                                multi_items[ "right" ] = library:create( "Frame" , {
                                    Parent = multi_items[ "tab" ];
                                    BackgroundTransparency = 1;
                                    Name = "\0";
                                    BorderColor3 = rgb(0, 0, 0);
        ...
        function library:dropdown(options) 
            ...
            function cfg.set(value)
                ...
                items[ "sub_text" ].Text = if isTable then concat(selected, ", ") else selected[1] or ""
        ...
        function library:init_config(window) 
            ...
            local section = main:section({name = "Configs", side = "left", size = 1, default = true, icon = "rbxassetid://139628202576511"})
            ...
            local section = main:section({name = "Settings", side = "right", size = 1, default = true, icon = "rbxassetid://129380150574313"})
